...
#if LEPUS_FORCE_API_OPENGL || LEPUS_FORCE_API_VK || LEPUS_FORCE_API_TEST
#else
...
namespace lepus
{
	...
	class GraphicsApiOptions
	{
	    ...
	    static GraphicsApiOptionsClass Create(const system::Windowing* windowing, GraphicsApiType type);
	};
#endif

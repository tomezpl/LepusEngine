...
namespace LepusEngine
{
	namespace Lepus3D
	{
		...
		public:
			...
			Vector2& operator=(Vector2& rs) { return Vector2(rs.x, rs.y); };
		...
		public:
			...
			Vector3& operator=(Vector3& rs) { return Vector3(rs.x, rs.y, rs.z); };
		...
		public:
			...
			Vector4& operator=(Vector4& rs) { return Vector4(rs.x, rs.y, rs.z, rs.w); };
